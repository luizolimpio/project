...
urlpatterns += patterns('lfs.core.views',
    url(r'^$', "home", name="lfs_shop_home"),
    url(r'^Estado/(?P<slug>[-\w]+)/$', "homeestado", name='lfs_shop_homeestado'),
    url(r'^tobias$', "shop_view", name="lfs_shop_view"),
    url(r'^cidade$', "shop_view_cidade", name="lfs_shop_cidade"),
    url(r'^categorias$', "sort_categories", name="lfs_sort_categories"),
    url(r'^imagens$', "criar_miniatura_imagem", name="lfs_criar_imagem"),
)
...
urlpatterns += patterns('lfs.cart.views',
    ...
    url(r'^cartnovo$', "cartnovo", name="lfs_cartnovo"),
...
urlpatterns += patterns('lfs.customer.views',
    ...
    url(r'^pageinicial-login', "login_pageinicial", name="lfs_login_pageinicial"),
